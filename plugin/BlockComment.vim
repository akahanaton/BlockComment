...
function! CommentStr()
	...
	elseif &ft == "cpp" || &ft == "java" || &ft == "javascript" || &ft == "php" || &ft == "cs" || &ft == "typescript" || &ft == "json"
		let s:comment_strt = '// '
		let s:comment_mid0 = '// '
		let s:comment_mid1 = '// '
		let s:comment_stop = ''
...
function! UnComment() range
	...
	let l:indent = indent( l:firstln - 1 )
	...
	let l:indent = indent( l:lastln + 1 )
